...
<head>
    ...
    <title>Laravel · PHP-FPM · Nginx · Unix Socket</title>
...
<div class="main-wrapper">
    <div class="main-inner">
        <div class="content-panel">
            ...
            <div class="section">
                ...
                <div class="services-list">
                    <div class="service-row">
                        ...
                        <span class="service-name">Nginx · PHP-FPM · Unix Socket</span>
                        <span class="service-env">меньше overhead между web и app</span>
                    </div>
                    <div class="service-row">
            ...
            <div class="section">
                <div class="section-title">Почему эта связка хороша в production</div>
                <table class="compare-table">
                    ...
                    <tr>
                        <td>Nginx</td>
                        <td>Статика и FastCGI</td>
                        <td class="highlight">стабильный трафик</td>
                    </tr>
                    <tr>
                        <td>Unix Socket</td>
                        <td>Локальный IPC</td>
                        <td class="highlight">ниже latency</td>
                    </tr>
                    <tr>
                        <td>PHP-FPM</td>
                        <td>Пулы и лимиты</td>
                    ...
                    <tr>
                        <td>Stateless</td>
                        <td>Чистый запрос</td>
                        <td class="highlight">меньше багов</td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="hero-panel">
            ...
            <div class="hero-badge">
                <div class="hero-title">PHP-FPM · Nginx · Unix Socket</div>
...
<footer class="site-footer">
    Laravel + PHP-FPM + Nginx over Unix Socket · <a href="https://www.php.net/manual/en/install.fpm.php" class="footer-link">php.net/manual/en/install.fpm.php</a>
</footer>
</body>
</html>
